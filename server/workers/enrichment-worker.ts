...
const ALWAYS_REJECT_TITLE_PATTERNS = [
  ...
  /\bsocial media market/i,
  /\bcompensation (manager|analyst|specialist)\b/i,
  /\bcompensation & benefits\b/i,
  /\bbenefits program\b/i,
  /\bpeople business partner\b/i,
  /\bpeople operations\b/i,
  /\bhr (manager|specialist|generalist|partner)\b/i,
  /\bhuman resource/i,
  /\bnotary public\b/i,
  ...
  /\btalent pool\b/i,
  /\bfuture opening/i,
  /\bcontent marketing manager\b/i,
  /\bgrowth marketing generalist\b/i,
  /\bexecutive assistant\b/i,
  /\bfacilities specialist\b/i,
  /\bradiologist\b/i,
  /\bclinical operations manager\b/i,
  /\bclinical workflow\b/i,
  /\bmedical (ai|foundation model)/i,
  /\bphysician\b/i,
