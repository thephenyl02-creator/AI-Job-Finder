...
import { Search, FileText, Briefcase, Users, Target, Sparkles } from "lucide-react";
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-12">
        <div className="text-center mb-12">
          <h1 className="text-3xl font-serif font-medium text-foreground mb-4">
            About Legal AI Careers
          </h1>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            The job search platform built for legal professionals entering the technology sector.
          </p>
        </div>
        ...
        <div className="space-y-8">
          <Card>
            ...
            <CardContent className="text-muted-foreground space-y-4">
              <p>
                Legal AI Careers connects legal professionals with opportunities in the growing 
                ...
                or a law school graduate exploring non-traditional paths, we're here to help 
              ...
              <div className="grid md:grid-cols-2 gap-6">
                ...
                <div>
                  ...
                  <ul className="text-sm text-muted-foreground space-y-1">
                    ...
                    <li>Data scientists and AI researchers</li>
            ...
            <CardContent>
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center">
                  ...
                  <h3 className="font-medium text-foreground mb-1">AI-Powered Search</h3>
                  <p className="text-sm text-muted-foreground">
                    Describe your ideal role in plain language. Our AI matches you with relevant positions.
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Upload your resume and we'll automatically find jobs that match your experience.
                  </p>
                </div>
                <div className="text-center">
                  <div className="w-12 h-12 bg-primary/10 rounded-lg flex items-center justify-center mx-auto mb-3">
                  ...
                  <p className="text-sm text-muted-foreground">
                    All jobs are scraped from actual company career pages. Apply directly to employers.
                  </p>
                </div>
              </div>
            </CardContent>
